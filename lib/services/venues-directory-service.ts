...
export const TRADING_VENUES: TradingVenue[] = [
  ...
  // ─── GLOBAL & MULTI-REGION VENUES ───
  {
    id: 'tessera',
    name: 'Tessera',
    tagline: 'Permissionless Pre-IPO Equities (OpenAI, Kalshi, SpaceX) on Solana',
    description:
      'Decentralized private equity protocol on Solana tokenizing premier pre-IPO equities (OpenAI, Kalshi, SpaceX). Trade T-Tokens permissionlessly on DEXs with zero KYC, continuous price discovery, and transparent collateral reserve backing.',
    category: 'RWA Protocol',
    country: 'United States / Global',
    countryCode: 'US',
    region: 'Global / Multi-Region',
    flag: '🌐',
    domain: 'app.tessera.pe',
    logoUrl: 'https://www.google.com/s2/favicons?domain=tessera.pe&sz=128',
    brandColor: '#10B981',
    websiteUrl: 'https://app.tessera.pe',
    appUrl: 'https://app.tessera.pe',
    solanaNetworks: ['devnet', 'mainnet-beta'],
    solanaFeatures: {
      nativeSolana: true,
      supportsUsdcSolana: true,
      token2022Compliant: true,
      settlementSpeed: '~400ms On-Chain',
    },
    supportedAssets: ['OPENAI.T', 'KALSHI.T', 'SPACEX.T', 'USDC'],
    paymentMethods: ['USDC (Solana)', 'SOL', 'Raydium Swap'],
    pricingAndFees: {
      tradingFee: '0.25% DEX Swap Fee',
      depositFee: 'Zero (Self-Custodial)',
      withdrawalFee: '~0.000005 SOL (Network fee)',
      minTradeAmount: '$1.00',
    },
    kycRequirement: 'None (Self-Custodial DeFi)',
    ...
    liquidityMetrics: {
      ...
      activePoolsCount: 4,
      topPools: [
        { pair: 'OPENAI.T-USDC', liquidity: '$8.2M', volume24h: '$1.4M', apr: '42.5%' },
        { pair: 'KALSHI.T-USDC', liquidity: '$6.3M', volume24h: '$980K', apr: '36.8%' },
      ],
    },
    storeRatings: {
      googlePlay: { rating: 4.8, totalReviews: '310', url: 'https://app.tessera.pe' },
      appStore: { rating: 4.9, totalReviews: '190', url: 'https://app.tessera.pe' },
    },
    reviewsList: [
      {
        id: 'tes-1',
        author: 'Alex R. (DeFi Trader)',
        rating: 5,
        date: 'September 2026',
        reviewText: 'Trading OpenAI and Kalshi tokens on Solana DEXs without accreditation hurdles is revolutionary. The liquidity on Raydium is solid.',
        source: 'Community Verified',
        sourceUrl: 'https://app.tessera.pe',
        verifiedBuyer: true,
      },
      {
        id: 'tes-2',
        ...
        rating: 5,
        date: 'September 2026',
        reviewText: 'Tessera T-Tokens give retail investors real pre-IPO upside with instant on-chain settlement and zero KYC friction.',
        source: 'Trustpilot',
        sourceUrl: 'https://app.tessera.pe',
        verifiedBuyer: true,
      },
