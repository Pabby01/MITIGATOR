...
> = {
  ...
  METAx: {
    ...
    eps: 24.1,
    dividendYield: 0.35,
    sharesOutstanding: 2_548_000_000,
    score: 86,
    sentiment: 76,
    volatility: 34,
    liquidity: 91,
  ...
  AMDx: {
    ...
    eps: 3.46,
    dividendYield: null,
    sharesOutstanding: 1_618_000_000,
    score: 80,
    sentiment: 69,
    volatility: 46,
    liquidity: 87,
  ...
  VTIx: {
    ...
    eps: 15.07,
    dividendYield: 1.38,
    sharesOutstanding: 6_042_000_000,
    score: 93,
    sentiment: 72,
    volatility: 17,
    liquidity: 96,
  ...
  VOOx: {
    ...
    eps: 27.81,
    dividendYield: 1.42,
    sharesOutstanding: 2_435_000_000,
    score: 94,
    sentiment: 73,
    volatility: 15,
    liquidity: 98,
  ...
  TSMx: {
    ...
    eps: 6.46,
    dividendYield: 1.15,
    sharesOutstanding: 5_184_000_000,
    score: 87,
    sentiment: 77,
    volatility: 35,
    liquidity: 89,
  ...
  SPCXx: {
    ...
    eps: 2.75,
    dividendYield: null,
    sharesOutstanding: 1_389_000_000,
    score: 82,
    sentiment: 84,
    volatility: 62,
    liquidity: 75,
  ...
  'OPENAI.T': {
    name: 'OpenAI Pre-IPO Token (Tessera)',
    tokenSymbol: 'OPENAI.T',
    sector: 'Technology',
    ...
    eps: 0.59,
    dividendYield: null,
    sharesOutstanding: 3_529_000_000,
    score: 85,
    sentiment: 91,
    volatility: 58,
    liquidity: 78,
  ...
  'KALSHI.T': {
    name: 'Kalshi Pre-IPO Token (Tessera)',
    tokenSymbol: 'KALSHI.T',
    sector: 'Financial',
  ...
  PLTRx: {
    ...
    eps: 0.86,
    dividendYield: null,
    sharesOutstanding: 2_208_000_000,
    score: 81,
    sentiment: 82,
    volatility: 54,
    liquidity: 89,
  ...
  BABAx: {
    ...
    eps: 6.94,
    dividendYield: 2.10,
    sharesOutstanding: 2_393_000_000,
    score: 74,
    sentiment: 59,
    volatility: 40,
    liquidity: 81,
  ...
  CRCLx: {
    ...
    tokenSymbol: 'CRCLx',
    sector: 'Financial',
    industry: 'Fintech & Digital Dollar',
  ...
  DKNGx: {
    ...
    tokenSymbol: 'DKNGx',
    sector: 'Consumer Cyclical',
    industry: 'Gambling & Sports Gaming',
  ...
  BRKx: {
    ...
    eps: 24.24,
    dividendYield: null,
    sharesOutstanding: 2_158_000_000,
    score: 95,
    sentiment: 81,
    volatility: 14,
    liquidity: 94,
