    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 selection:text-primary">
      ...
      <section className="py-12 px-6 max-w-5xl mx-auto space-y-6">
        <div className="text-center space-y-2 mb-8">
          <h2 className="text-2xl md:text-3xl font-black tracking-tight">The 7-Tier Data Provenance Hierarchy</h2>
        ...
        <div className="space-y-3">
          {SEVEN_TIERS.map((tier, idx) => (
            <GlassPanel
              key={tier.tier}
              className="p-5 hover:border-primary/40 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4"
            >
