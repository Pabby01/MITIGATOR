    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 selection:text-primary">
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          <h2 className="text-2xl md:text-3xl font-black tracking-tight">The 8 Quantitative Risk Factors</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {EIGHT_FACTORS.map((factor) => {
            ...
            return (
              <GlassPanel key={factor.num} className="p-5 space-y-3 hover:border-primary/40 transition-all flex flex-col justify-between">
      ...
      <section className="py-16 px-6 bg-card/25 border-y border-border/40">
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-2xl md:text-3xl font-black tracking-tight">Score Bands &amp; Automated Guardrails</h2>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto space-y-6">
        <GlassPanel className="p-6 md:p-8 space-y-4 border-primary/30 bg-gradient-to-r from-primary/5 via-card/50 to-primary/5">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto rounded-3xl border border-primary/30 bg-card/60 p-8 md:p-12 text-center space-y-6 shadow-2xl">
